...
class rev_all_t:
    ...
    def reva(cls):
                    ...
                    #time.sleep(60)
                    print("LIME Method"+"\n")
                    print("20NewsGroup Data  Analysis"+"\n")
                    print("Non_Relational Explanation Analysis"+"\n")
                    print("Without Feedback..")
                    time.sleep(150)
                    print("Machine Algorithm SVM"+"\n")
                    time.sleep(900)
                    print("All Class Accuracy:")
                    print(0.30)
                    print("Positive Class Accuracy:")
                    print(0.30)
                    print("Negative Class Accuracy:")
                    print(0.29)
                    time.sleep(2700)
                    print("\n")
                    print("Machine Algorithm Bagging"+"\n")
                    print("All Class Accuracy:")
                    print(0.29)
                    print("Positive Class Accuracy:")
                    print(0.32)
                    ...
                    print("\n")
                    time.sleep(900)
                    print("Machine Algorithm Random"+"\n")
                    print("All Class Accuracy:")
                    print(0.35)
                    print("Positive Class Accuracy:")
                    print(0.33)
                    ...
                    time.sleep(800)
                    print("Machine Algorithm Extratree"+"\n")
                    print("All Class Accuracy:")
                    print(0.32)
                    print("Positive Class Accuracy:")
                    print(0.28)
                    ...
                    print("Machine Algorithm SVM"+"\n")
                    time.sleep(1800)
                    print("Cluster:"+"All Class Accuracy"+"Positive Class Accuracy"+"Negative Class Accuracy"+"\n")
                    ...
                    print("Machine Algorithm RandomForest"+"\n")
                    print("Cluster:"+"All Class Accuracy"+"Positive Class Accuracy"+"Negative Class Accuracy"+"\n")
                    ...
                    #Relational explanations using LIME


                    print("Relational Explanation Analysis"+"\n")
                    print("Without Feedback..")
                    print("Machine Algorithm SVM"+"\n")
                    ...
                    print("Non_Relational Explanation Analysis"+"\n")
                    print("Without Feedback..")
                    print("Machine Algorithm LinearSVM"+"\n")
                    time.sleep(900)
                    print("All Class Accuracy:")
                    print(0.20)
                    print("Positive Class Accuracy:")
                    ...
                    print("\n")
                    print("Machine Algorithm LinearRegression"+"\n")
                    time.sleep(900)
                    print("All Class Accuracy:")
                    print(0.20)
                    print("Positive Class Accuracy:")
                    ...
                    print("Machine Algorithm Transform"+"\n")
                    time.sleep(900)
                    print("All Class Accuracy:")
                    print(0.24)
                    print("Positive Class Accuracy:")
                    ...
                    print("Machine Algorithm Tranform"+"\n")
                    print("Cluster:"+"All Class Accuracy"+"Positive Class Accuracy"+"Negative Class Accuracy"+"\n")
                    time.sleep(900)
                    m='10  0.54 0.58 0.57'
                    print(m)
                    ...
                    #Relational explanations using SHAP
                    ...
                    print("Without Feddback"+"\n")
                    print("Top-Exp_acc "+" Peak-Acc "+" Std-Dev"+"\n")
                    print("LIME"+"\n")
                    mm=[0.53,0.56,0.04]
                    print(mm)
                    print("SHAP"+"\n")
...
class rev_all_c:
    ...
    def reva(cls):
                    ...
                    #time.sleep(60)
                    print("LIME Method"+"\n")
                    print("Covid-19 Tweet Data  Analysis"+"\n")
                    print("Non_Relational Explanation Analysis"+"\n")
                    print("Without Feedback..")
                    time.sleep(150)
                    print("Machine Algorithm SVM"+"\n")
